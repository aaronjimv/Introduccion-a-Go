...
func main() {
	...
	http.ListenAndServe(":8000", nil) // crea un sevidor virtual en el puerto :8000
}

/*
de tener dos parametros en ese orden
  - http.ResponseWriter es una estructura que define como se va a responder a la peticion
