/*
	NOTA 1:
	las go rountine se ejecutan en el fondo. entoces cuando llega a la line de go ---
	...
	a un numero especifico para eso se pone la gorountine en una funcion anonima
		...
		go func () {
			contador("hola")
			wg.Done() // decrementa el contador para parar el gorountine 
		}()
	
		wg.Wait() // espera a que llgue acero
*/
package main 
