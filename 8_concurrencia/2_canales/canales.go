/*
	los conales son para comunicar ejecuciones de codigo concurente via un canal


	nota: 
	cuando se envia informacion la info esta del lado derecho y el canal del izquierdo
	cuando se recive info el canal en el izquieldo y la variable que recibe al info en el derecho
	...
	nota 3:
	aunque la var nombre esta declarada detron del for el canal conserva su informacion
