...
func main() {
	...
	tutor := Tutor{Humano{"Aaron"}}

	fmt.Println(tutor.nombre) // aunque Tutor no tiene un campo nombre, Humano	si
	//tambien sirve tutor.Humano.nombre pero es cuando hay dos campos anonimos con el mismo nombre de atributo
