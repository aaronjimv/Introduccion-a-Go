...
// la parabra reservada `comparable` solo soporta operaciones de `==` y `!=`
...
// `constraints.Ordered` es un tipo de dato del paquete constraints que permite usar mas operadores como `>`, `<`, etc.
